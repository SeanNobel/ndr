...
from .direction_sensitive_geometric import (
...
class NDRGeometric(RegularizedLayer, LayerWithVisualization):
    def __init__(
        ...
        **kwargs
        ...
        self.att = DirectionSensitiveGeometricAttentionMyInit(
            d_model,
            nhead,
        ...
        self.g2 = torch.nn.Linear(
            d_model * gate_size_multiplier, 1 if scalar_gate else d_model
        )
    ...
    def reset_parameters(self):
        ...
        torch.nn.init.xavier_uniform_(
            self.p2.weight, gain=torch.nn.init.calculate_gain("tanh")
        )
